...
include '/home/tejas/anaconda3/envs/qutip-env/lib/python3.6/site-packages/qutip/cy/complex_math.pxi'
...
def cy_td_ode_rhs(
    ...
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], (0 if (t > 6.283185) else _td_array_0[int(round(499 * (t/6.283185)))]), out, num_rows)
